...
public class TopNightPlaylist {
    public static void main(String[] args){
        //initialize things
        double score = 50;
        Playlist thisYearsTopPlaylist = new Playlist();
...
/*
        ...
        Playlist topsforrael = thisYearsTopPlaylist.topList();

        //prints the playlist to the output
        System.out.println("Out of a total of " + thisYearsTopPlaylist.size() + " songs");

        //System.out.println("The most added artist was " + playlist.topArtist());
        System.out.println(topsforrael.toString());
    }
}